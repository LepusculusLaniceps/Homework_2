public class Main {
    ...
    public static void task7 () {
        ...
        var differenceWeight2 = boxerTwoWeight % boxerOneWeight;
    ...
    public static void task8 () {
        ...
        var amountOfEmployees = totalWorkHours / oneEmployeeWorks;
        System.out.println("Всего работников в компании — " + amountOfEmployees + " человек.");



        var amountOfEmployees1 = amountOfEmployees + 94;
        var totalWorkHours1 = amountOfEmployees1 * oneEmployeeWorks;
        System.out.println("Если в компании работает " + amountOfEmployees1 + " человек, то всего " + totalWorkHours1 + " часов работы может быть поделено между сотрудниками.");
